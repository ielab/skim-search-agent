...
| `sieve.py` | `sieve_bm25`, `sieve`, `sieve_dense`, `sieve_nosnip`, `sieve_nomanual`, `sieve_card`, `sieve_syntax`, `sieve_noconstruct`, `sieve_nohowto`, `sieve_nofields`, `sieve_nofetch`, `sieve_nohops`, `sieve_noexamples`, `sieve_nomistakes`, `sieve_refhowto`, `sieve_refhops`, `sieve_refmistakes`, `sieve_paper_manual`, `sieve_plain`, `sieve_v2`, `sieve_visit`, `sieve_visit_fused`, `sieve_visit_dense` | `search_bql` (snippets, ranking model, manual set) then `fetch` or `visit` |
