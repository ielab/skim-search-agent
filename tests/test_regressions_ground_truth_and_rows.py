"""Regression tests for tool-call parsing edge cases (answer/think markers, close tags inside
argument values), diff-based ground-truth line ranges, pyserini truncation handling, and
run_eval row loading/resumption (tolerating a truncated trailing line, BEIR gold reachability
vs chunking)."""
import json
import os
import tempfile
