"""Regression tests for correctness bugs found in the audit (see PAPER review).
Each test pins a previously-wrong behavior.
"""
...
def test_acc_at_k_is_zero_at_k0():
    from evaluation.metrics import acc_at_k
