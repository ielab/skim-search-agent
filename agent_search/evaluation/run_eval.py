...
from agent_search.core.tokens import count_tokens, ruler_name
...
def _resolve_env_knobs() -> dict:
    ...
    try:
        ...
        pass
    try:
        from agent_search.agent.tools.doc_dci import BASH_MAX_TOKENS, READ_MAX_LINE_TOKENS
        knobs["BASH_MAX_TOKENS"] = BASH_MAX_TOKENS
        knobs["READ_MAX_LINE_TOKENS"] = READ_MAX_LINE_TOKENS
    except Exception:
        pass
    try:
        from agent_search.agent.tools.doc_research import HYBRID_VISIT_TOPK
