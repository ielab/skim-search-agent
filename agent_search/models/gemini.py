"""Gemini via its OpenAI-compatible endpoint — same client class as `openai_compat_generate`,
just pointed at Google's server."""
...
# calls (via `gemini_generate` below) with this base_url + key — no separate SDK/client type
# needed.
