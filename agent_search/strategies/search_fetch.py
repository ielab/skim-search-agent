...
search_fetch = register_strategy(Strategy(
    ...
    tools=(SearchBm25(name="bm25_search_snip", structure=True, snippets=True), Fetch(name="fetch"))))
...
search_fetch_dense = register_strategy(Strategy(
    ...
    tools=(SearchDense(name="dense_search_f", structure=True, snippets=True), Fetch(name="fetch"))))
...
search_fetch_hybrid = register_strategy(Strategy(
    ...
    tools=(SearchHybrid(name="hybrid_search_snip", structure=True, snippets=True), Fetch(name="fetch"))))
...
search_fetch_bm25_plain = register_strategy(Strategy(
    ...
    tools=(SearchBm25(name="bm25_search", structure=True, snippets=False), Fetch(name="fetch"))))
...
search_fetch_dense_plain = register_strategy(Strategy(
    ...
    tools=(SearchDense(name="dense_search_fp", structure=True, snippets=False), Fetch(name="fetch"))))
